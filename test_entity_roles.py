...
def test_canon_warning():
    ...
    check("і рахує їхню частку від згадок того ж написання",
          "6%" in line, txt_bw)
    ...
    # Одна згадка чужого носія — викид витягу, а не другий носій посади.
    outlier = {**clean,
    ...
    check("а на десятках згадок перевірка вже зайва — це очевидні носії",
          "/roles_who" not in txt_bw, txt_bw)
