...
from handlers.promises import (
    ...
    promise_audit_handler, promise_embed_test_handler,
...
def main():
    ...
    app.add_handler(CommandHandler("promise_classify", promise_classify_handler))
    ...
    app.add_handler(CommandHandler("promise_embed_test", promise_embed_test_handler))
