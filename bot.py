...
from handlers.entity_links import (
    entity_links_handler, entity_link_handler, entity_unlink_handler,
)
...
from handlers.promise_fulfil import (promise_fulfil_handler,
                                     ...
                                     promise_auto_callback,
                                     promise_fulfil_test_handler)
...
def main():
    ...
    app.add_handler(CommandHandler("entity_links", entity_links_handler))
    app.add_handler(CommandHandler("entity_link", entity_link_handler))
    app.add_handler(CommandHandler("entity_unlink", entity_unlink_handler))
    ...
    app.add_handler(CommandHandler("promise_glitches", promise_glitches_handler))
    app.add_handler(CommandHandler("promise_vague", promise_vague_handler))
