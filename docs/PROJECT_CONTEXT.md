...
24. **«Активні користувачі» Viber напівавтоматом** — метрика живе лише на екрані Insights каналу (застосунок, тільки супер-адміни; API її не віддає), але там є кнопка **Download — JSON з даними за останні 90 днів** (DAU/MAU, нові користувачі, повідомлення, реакції; довше 90 днів Viber не зберігає). План: супер-адмін раз на місяць тисне Download і кидає JSON Лису в приват — бот сам розкладає в таблицю аналітики (колонка D блоку Viber) і нору, той самий патерн, що ZIP бюджету. Перед кодом потрібен реальний зразок експорту (правило №3 — не вигадувати формат); попросити в Олега/Лізи файл і подивитись структуру.
