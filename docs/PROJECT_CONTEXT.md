...
2. **Конкуренти — підводка AI** — ❌ ВІДХИЛЕНО (07.2026): підводку підключили, спробували в проді і прибрали за рішенням Олега — системний вигляд кращий. Функцію видалено з ai_messages.py.
