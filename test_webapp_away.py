...
BOOT = {
    ...
    "assignees": [], "managers": [], "tasks": [
        ...
        _task(1, "Кристина Леонова", "2026-08-12"),
        # дедлайн поза будь-якою відсутністю — спокійна засічка
        _task(2, "Кристина Леонова", "2026-08-25"),
        # закритий таск усередині відпустки — не турбує нікого
        _task(3, "Кристина Леонова", "2026-08-13", status="done"),
        # чужий таск усередині ЇЇ відпустки — теж не зіткнення
        _task(4, "Аліна Квітко", "2026-08-12"),
    ],
}

ABSENCES = [
    {"id": 11, "person": "Кристина Леонова", "start": "2026-08-10",
     "end": "2026-08-17", "kind": "vacation", "title": "Відпустка",
...
REQUESTS = [
    {"id": 21, "person": "Аліна Квітко", "start": "2026-09-01",
     "end": "2026-09-05", "kind": "trip", "title": "Відрядження",
