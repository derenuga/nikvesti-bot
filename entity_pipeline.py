...
# ---------- Профілактика дублів органів влади (16.08.2026) ----------
#
# Ключ вище знімав ЛИШЕ правову форму — і цього виявилось замало. Розбір
# дублів 16.08 показав, чим насправді відрізняються картки одного органу:
# одне обласне управління ДСНС жило 20 картками, ГУНП — 15, ГУ ДПС — 17,
# міськрада з управліннями дала 70 злиттів. Правова форма там ні до чого,
# різниця у ТРЬОХ речах, і всі три механічні:
#
#   1. абревіатура проти розкритої назви («ГУ ДСНС України у Миколаївській
#      області» = «Головне управління Державної служби з надзвичайних
#      ситуацій України у Миколаївській області»);
#   2. форма топоніма («Миколаївської міської ради» = «міської ради
#      Миколаєва» = «міськради Миколаєва»);
#   3. порядок слів («Обласна військова адміністрація Миколаївської
#      області» = «Миколаївська обласна військова адміністрація»).
#
# Тому ключ тепер: розкрити абревіатури → звести топоніми до основи →
# викинути службові слова й «України» → ВІДСОРТУВАТИ слова. Останнє і
# лікує порядок: набір слів однаковий, послідовність не має значення.
#
# ЧОГО ключ навмисно НЕ робить. Він не зводить те, що розрізняється хоч
# одним значущим словом, — саме на цьому тримаються межі, які ми провели
# руками того ж дня:
#   «Миколаївська окружна прокуратура» (районна) ≠ «Окружна прокуратура
#   МІСТА Миколаєва» — слово «міста» лишається в ключі;
#   міська рада ≠ обласна рада ≠ виконком ≠ мерія;
#   ГУНП ≠ управління ПАТРУЛЬНОЇ поліції (різні органи, і саме тому їх не
#   злили);
#   обласне управління ДСНС ≠ управління НС МІСЬКРАДИ.
# Це не побічний ефект, а умова: автоматика має закривати клас написань, а
# не вирішувати, що є одним органом.
ORG_ABBR = {
    "дснс": "державна служба надзвичайних ситуацій",
    "гунп": "головне управління національної поліції",
    "дпс": "державна податкова служба",
    "упп": "управління патрульної поліції",
    "цнап": "центр надання адміністративних послуг",
    "жкг": "житлово комунального господарства",
    "вкг": "водопровідно каналізаційного господарства",
    "сбу": "служба безпеки",
    "держслужба": "державна служба", "держслужби": "державна служба",
    "нацполіція": "національна поліція", "нацполіції": "національна поліція",
    "держадміністрація": "державна адміністрація",
    "держадміністрації": "державна адміністрація",
    "мвс": "міністерство внутрішніх справ",
    "міськрада": "міська рада",
    "міськради": "міська рада",
    "міськраді": "міська рада",
    "ради": "рада", "раді": "рада", "радою": "рада",
    "облрада": "обласна рада",
    "облради": "обласна рада",
    "виконком": "виконавчий комітет",
    "виконкому": "виконавчий комітет",
    "міськвиконком": "виконавчий комітет міська рада",
    "облдержадміністрація": "обласна військова адміністрація",
    "облдержадміністрації": "обласна військова адміністрація",
    "ода": "обласна військова адміністрація",
    "ова": "обласна військова адміністрація",
    "мва": "міська військова адміністрація",
    "рва": "районна військова адміністрація",
    # ОДА і ОВА — та сама установа (рішення Олега 16.08: «зараз іде війна,
    # тому вона військова»). Коли війну скінчать, це місце теж доведеться
    # правити — воно named у docs/BACKLOG.md §1.5.1 разом із назвами карток.
}

# Форми топонімів → основа. Не морфологія, а курований список: у нашій норі
# 99% органів — миколаївські й сусідніх областей, а вгадана морфологія тут
# коштувала б злиття різних міст.
ORG_TOPONYMS = {
    "миколаївська": "миколаїв", "миколаївське": "миколаїв",
    "миколаївський": "миколаїв", "миколаївської": "миколаїв",
    "миколаївському": "миколаїв",
    "миколаївській": "миколаїв", "миколаївськими": "миколаїв",
    "миколаєва": "миколаїв", "миколаєві": "миколаїв", "миколаєвом": "миколаїв",
    "миколаївщини": "миколаїв", "миколаївщина": "миколаїв",
    "миколаївщині": "миколаїв",
    "одеська": "одеса", "одеської": "одеса", "одеській": "одеса",
    "одеське": "одеса", "одеський": "одеса", "одеси": "одеса",
    "одесі": "одеса", "одещини": "одеса", "одещина": "одеса",
    "херсонська": "херсон", "херсонської": "херсон", "херсонській": "херсон",
    "херсонський": "херсон", "херсонське": "херсон", "херсона": "херсон",
    "херсоні": "херсон", "херсонщини": "херсон", "херсонщина": "херсон",
    "київська": "київ", "київської": "київ", "київській": "київ",
    "київський": "київ", "києва": "київ", "києві": "київ",
    "вознесенська": "вознесенськ", "вознесенської": "вознесенськ",
    "вознесенський": "вознесенськ", "вознесенськом": "вознесенськ",
    "первомайська": "первомайськ", "первомайської": "первомайськ",
    "первомайський": "первомайськ", "першомайська": "первомайськ",
    "баштанська": "баштанка", "баштанської": "баштанка",
    "баштанський": "баштанка", "баштанське": "баштанка",
    "очаківська": "очаків", "очаківської": "очаків", "очакова": "очаків",
    "южноукраїнська": "південноукраїнськ", "южноукраїнської": "південноукраїнськ",
    "південноукраїнська": "південноукраїнськ",
    "південноукраїнської": "південноукраїнськ",
    "снігурівська": "снігурівка", "снігурівської": "снігурівка",
    "новоодеська": "нова одеса", "новоодеської": "нова одеса",
    "новобузька": "новий буг", "новобузької": "новий буг",
}

# Службові слова й «Україна» в ключі не тримаємо. «Україна» — бо вона стоїть
# то перед областю, то після, то взагалі відсутня («Головне управління ДСНС
# УКРАЇНИ у Миколаївській області» = «Головне управління ДСНС у Миколаївській
# області»), і жодного органу від іншого не відрізняє.
ORG_STOP = {
    "з", "зі", "у", "в", "та", "і", "й", "на", "при", "по", "для", "до",
    "від", "про", "питань", "справах", "україни", "україна", "український",
    "українська", "області", "область", "обл", "м",
}
# «міста» у списку НЕМАЄ свідомо: саме це слово відрізняє «Окружну прокуратуру
# МІСТА Миколаєва» від «Миколаївської окружної прокуратури» — а це різні
# установи (перевірено по статтях 16.08).

# Відсікання закінчення. Назви органів у статтях стоять то в називному, то в
# родовому («Головне управління Державної СЛУЖБИ» / «Державна СЛУЖБА»), і без
# цього кроку ключ ловить лише половину класу. Морфології тут не треба:
# ключ не читає людина, тож досить обрізати найчастіші закінчення в довгих
# словах. Коротші за 6 літер не чіпаємо взагалі — там обрізання починає
# склеювати різні слова.
ORG_ENDINGS = ("ськими", "ського", "ською", "ської", "ських", "ським", "ська",
               "ське", "ський", "ості", "ами", "ями", "ого", "ому", "ої", "ий",
               "ій", "ім", "их", "ах", "ях", "ам", "ям", "ів", "ей", "ею",
               "ою", "єю", "а", "и", "у", "ю", "я", "е", "о", "і", "ї")

# Заміни ЦІЛИМИ словосполученнями, до розбору на слова. Потрібні там, де
# різниця не в закінченні й не в скороченні, а в самому слові — і замінити
# його поодинці не можна: «державна» в «обласній державній адміністрації» це
# ОВА (рішення Олега 16.08), а «державна» в «державній службі» — ні.
ORG_PHRASES = [
    (re.compile(r"обласн\w+ державн\w+ адміністраці\w+"),
     "обласна військова адміністрація"),
    (re.compile(r"районн\w+ державн\w+ адміністраці\w+"),
...
def org_key(name, strict=False):
    ...
    return key if len(key) >= ORG_KEY_MIN else None
        ...
        if kind in ("org", "place"):
            for nm in (nua, nru):
                ...
                if not lk:
                    continue
                best = loose.get(lk)
                if best is not None and best != eid:
                    # ДВІ ЖИВІ картки з одним ключем — ключ тут не працює.
                    # Приклад із 16.08: «Миколаївська окружна прокуратура»
                    # (районна) і «Окружна прокуратура Миколаєва» (міська) —
                    # набір слів однаковий, установи різні, і розрізнити їх
                    # можна лише по статтях. Тихо віддати згадку тій, у кого
                    # більше згадок, — це підкинути монетку за людину, тому
                    # ключ для такої пари вимикається зовсім: нове написання
                    # заведе свою картку й потрапить у чергу дублів.
                    ambiguous.add(lk)
                    continue
                if best is None or recs[best]["mentions"] < rec["mentions"]:
                    loose[lk] = eid
