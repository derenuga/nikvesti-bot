...
NOTIFS = [
    {"id": 31, "kind": "task_done", "kind_title": "Завдання виконано",
     ...
     "meta": {"theme": "Критичні інформаційні потреби", "task_line": "3 новини",
              "donor": "IWPR", "person": "Юлія Бойченко"},
     "url": "https://nikvesti.com/news/economics/321844-tendery",
    ...
    async with async_playwright() as pw:
        ...
        try:
            ...
            check("видно, ЩО виконано — тематика першою",
                  "Критичні інформаційні потреби" in body)
            check("і завдання зі статусом", "3 новини" in body
                  and "зарахувала сама" in body)
            check("автор — унизу, поруч донор",
                  "Юлія Бойченко" in body and "IWPR" in body)
