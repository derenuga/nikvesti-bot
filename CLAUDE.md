...
| /sheet_format \[рік\] | Примусово перекатити оформлення річного листа таблиці аналітики (шапки з лого, формати ▲▼, формули, спарклайни, графіки); дані місяців не чіпає. «Голий» лист бот лікує й сам при наступному записі |
