...
webapp/                   — SPA Mini App «Команда» без збірки (index.html + style.css + app.js), дизайн v2: біло-синьо-голуба гама, SVG-іконки Feather (без емодзі-кнопок), повітря. Редакторський флоу: bottom-menu з «＋» → людина (кружечки-фото з сайту) → форма creative task; таби Проєкти (список «донор великим + строки» / таймлайн-ґант зі смугами проєктів, липкими лейблами і точкою «сьогодні»; тематики з розкроєм квот), KPI (норми по відділах → люди з прогрес-барами → шторка правки: інша ціль/звільнити/до норми), Команда. Картинки: ресайз .webp → фолбек оригінал → ініціали. Журналістка — «Мої KPI» (тиждень+місяць з фактом) і read-only список своїх тасків (її повний інтерфейс — наступний шар)
