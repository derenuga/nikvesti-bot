...
handlers/
  ...
  team_tasks.py           — creative tasks і тематики проєктів у Норі (team_creative_tasks/team_project_themes/team_task_events): завдання від редактора (людина × тип news/article × проєкт CMS або позапроєктне × тематика × к-сть × дедлайн × нотатка), статуси open→done/dropped, пінг виконавиці best-effort; тематика має формат (news/article/post/video/hybrid або без)
