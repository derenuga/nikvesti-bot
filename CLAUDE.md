...
| /team | Кнопка відкриття Mini App «Команда» (таски + проєкти + KPI): у приваті — нативна web_app, у групі — прямий лінк WEBAPP_DIRECT_LINK; без налаштованого WEBAPP_URL пояснює, чого бракує |
...
| 09:40 щодня | Нагадування про звітні дедлайни грантів у чат «Фінанси МикВісті» (FINANCE_CHAT_ID): пороги 7 і 2 доби — спрацьовує перший непройдений, тож пропущений день або відсутні права в чаті не гублять нагадування; подані й прийняті пропускаються, позначка ставиться лише після успішної відправки. У повідомленні — лінк на папку проєкту в Drive і кнопка «Дедлайни в апці» (WEBAPP_DIRECT_LINK + startapp=reports) |
...
FINANCE_CHAT_ID              # чат «Фінанси МикВісті» — нагадування про звітні дедлайни грантів; без неї модуль спить. Приймає і «сирий» id (4738653227), і канонічний (-1004738653227)
