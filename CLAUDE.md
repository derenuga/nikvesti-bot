...
| /sheet_format \[рік\] \[dark\|light\] | Примусово перекатити оформлення річного листа таблиці аналітики (шапки з лого, формати ▲▼, формули, спарклайни, графіки, тема); дані місяців не чіпає. Дефолтна тема — dark (env SOCIAL_SHEET_THEME); тема документа глобальна для всіх листів. «Голий» лист бот лікує й сам при наступному записі |
