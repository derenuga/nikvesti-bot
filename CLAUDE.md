...
webapp/                   — SPA Mini App «Команда» без збірки (index.html + style.css + app.js), дизайн v2: біло-синьо-голуба гама, SVG-іконки Feather (без емодзі-кнопок), повітря. Редакторський флоу: bottom-menu з «＋» → людина (кружечки-фото з сайту) → форма creative task; таби Проєкти (тематики з розкроєм квот), KPI (заглушка до рішення), Команда. Журналістка — read-only список своїх тасків (її інтерфейс — наступний шар)
