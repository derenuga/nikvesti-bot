...
| *(ZIP у приват, без команди)* | Пакет рішення сесії (нульовий бюджет чи зміни) → бот сам розбирає і нашаровує ревізію бюджету в схему budget; порядок = порядок надсилання |
...
| /budget_execution | Виконання бюджету з останнього місячного снапшота: розпорядники з планом періоду <80% («хто не виконав у термін»), звірка річного плану з ревізіями рішень |
...
| 11:20 щодня | Монітор місячних снапшотів бюджету (mkrada «Щомісячна інформація»): нові xlsx → нора + звіт виконання по розпорядниках у чат редакції; тихий, коли нового немає |
