...
CHECKS = {
    320092: [
        ...
        ("немає критерію — і він не вигаданий",
         lambda its: any(not _text(it, "criterion") for it in its),
         "«краще ніж було» неможливо ані підтвердити, ані спростувати"),
        ("хоч один запис визнано непідтверджуваним",
         lambda its: _has(its, verifiability="unfalsifiable"),
         "це і є мітка «популізм», виведена з порожніх полів"),
    ...
    317853: [
        ...
        ("тригер-подія названа",
         lambda its: any(_text(it, "trigger_event") for it in its),
         "перевірити можна лише коли приватизацію винесуть на сесію"),
