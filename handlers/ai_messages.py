...
TEAM = {
    ...
    "Олена Бондаренко": {
        # Юзернейма немає, тому тег за id — як у Марії та Сергія. Сам id
        # береться з team_roster.ROSTER (там він давно є); тут копія, бо
        # значення `tg` — це ГОТОВА розмітка, яку споживачі вставляють без
        # обробки. Міняється id — міняти в обох місцях.
        "tg": '<a href="tg://user?id=191642941">Олена</a>',
        "role": "фінансова менеджерка, звітність по грантах",
    },
    "Юлія Бойченко": {
        "tg": "@boichenko13",
