...
TOOLS = [
    ...
    },
    {
        ...
        "description": (
            ...
            "Фільтри: own_material=true — тільки власні матеріали редакції (не рерайт), для питань "
            "типу 'що МИ писали'; tag — точна назва тегу; category — слаг рубрики; region — код регіону. "
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "own_material": {"type": "boolean", "description": "true — тільки власні матеріали редакції (не рерайт/агентське)"},
