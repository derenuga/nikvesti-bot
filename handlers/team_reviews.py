...
Чому чотири виміри, три рівні і ЖОДНОГО бала
--------------------------------------------
Спека (§«Картка перегляду», п. 2) вимагає «чотири виміри, три рівні, без
середнього арифметичного». Тут це не побажання в коментарі, а властивість
СХЕМИ: у кожного виміру власні слова, а не спільна шкала 1–3. «Приносить теми
сама» і «Завжди в строк» неможливо додати одне до одного й поділити на два —
навіть якщо дуже захотіти. Якби рівні були числами, перше, що зробив би будь-хто
...
Споживач (картка перегляду, крок 3) отримує чотири СЛОВА і рядок тексту.

«Складність» — це опис РОБОТИ, а не оцінка людини
--------------------------------------------------
Найнебезпечніший вимір із чотирьох. «Переважно стрічка» не означає «гірша
журналістка»: стрічку хтось має вести, і Newsroom існує саме для цього. Вимір
потрібен, щоб побачити, кому дістається складне, а кому роками не дістається
— і це питання до РОЗПОДІЛУ роботи, а не до людини. Тому він названий «Що
переважає», а не «Рівень», і в UI не має кольору «погано → добре».
...
DIMENSIONS = (
    {
        "key": "accuracy",
        "title": "Точність",
        "hint": "скільки правок після здачі",
        "levels": (
            ("clean", "Правок майже не треба"),
            ("normal", "Звичайні правки"),
            ("heavy", "Доводиться переписувати"),
        ),
    },
    {
        "key": "initiative",
        "title": "Самостійність",
        "hint": "тему знаходить сама чи треба ставити",
        "levels": (
            ("brings", "Приносить теми сама"),
            ("picks", "Підхоплює запропоноване"),
            ("needs", "Потрібно ставити"),
        ),
    },
    {
        "key": "complexity",
        # Свідомо не «Складність» і не «Рівень»: це опис роботи, яка їй
        # дістається, а не оцінка того, на що вона здатна
        "title": "Що переважає",
        "hint": "яку роботу їй дає редакція",
        "levels": (
            ("investigation", "Розслідування і великі теми"),
            ("own", "Власні матеріали"),
            ("feed", "Переважно стрічка"),
        ),
    },
    {
        "key": "reliability",
        ...
        "levels": (
            ...
            ("slips", "Іноді зсуває"),
            ("watch", "Строк доводиться контролювати"),
        ),
    },
)
