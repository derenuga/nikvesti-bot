...
def _question_text(p):
    ...
    # Одна-дві згадки — це зазвичай викид витягу, а не другий носій посади;
    # кричати про нього означало б знецінити крик там, де він справжній.
