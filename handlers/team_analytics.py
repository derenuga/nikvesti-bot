...
# 2,6 → 3,5 від 28.07): власна новина коштує редакції приблизно як три з
# половиною звичайні, тож «хто більше зробив» — це НЕ «хто більше рядків
# опублікував». Рейтинг і довжина барів ідуть за цією вагою, а в самій цифрі
# лишається чесна кількість.
#
# Число їде у payload (`own_weight`) і звідти в підпис під списком: інакше
# текст «власний матеріал = 2,6 звичайних» жив би у фронті окремою копією і
# розійшовся б із константою при першій же зміні.
OWN_WEIGHT = 3.5
