...
def sanitize_news_links(text, items):
    ...
    return _ANCHOR_RE.sub(_fix, text)
...
- URL у href бери РІВНО як у полі URL новини, символ-у-символ. КАТЕГОРИЧНО ЗАБОРОНЕНО конструювати, «відновлювати» чи транслітерувати слаг із заголовка: у старих новин слага НЕМАЄ, їхній канонічний лінк — короткий (/news/business/143444), і будь-який вигаданий хвіст дає 404.
