...
- Посилання на кожну новину встав HTML-гіперлінком прямо в текст: <a href="URL">анкор</a>. Анкор — дієслівна фраза факту («повідомляли», «писали», «ставало відомо», «атакували громаду»), НЕ «тут»/«за посиланням» і НЕ голий URL. Анкор короткий — МАКСИМУМ 3 слова. Кожна новина — один лінк.
