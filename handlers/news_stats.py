...
def count_news(title_contains=None, year=None, month=None, year_from=None, year_to=None,
               ...
               language=None, group_by=None):
    """Підрахунок опублікованих матеріалів у nodes за фільтрами. Одне число або
    розбивка (group_by). Див. докстрінг модуля і опис NLQ-tool count_news."""
