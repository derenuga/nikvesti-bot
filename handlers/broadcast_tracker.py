...
який стосувався б цих повідомлень). group_query_trigger в bot.py звіряється
з цим реєстром і мовчки ігнорує такі reply (якщо в них немає явної згадки
бота), замість того щоб Claude намагався вигадати відповідь через
GA4/Search Console tools.
